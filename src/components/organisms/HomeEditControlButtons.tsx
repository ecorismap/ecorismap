...
import { isFreehandTool, isPlotTool, isHandwritingTool } from '../../utils/General';
...
export const HomeEditControlButtons = React.memo(() => {
  ...
  if (!isEditingObject || !(isPlotTool(currentDrawTool) || isFreehandTool(currentDrawTool) || isHandwritingTool(currentDrawTool)))
    return null;
